...
describe("buildQaSuiteSummaryJson", () => {
  ...
  it("records Multipass channel-driver metadata when selected", () => {
    ...
    expect(json.run.channelDriver).toBe("multipass");
    ...
    expect(json.run.channelCapabilityMatrixPath).toBe("multipass-channel-capability-matrix.json");
  });
